...
for type in $source_list; do
    for i in $(seq 1 10); do
        ...
        for j in $(seq 4 4 16); do
            ...
            for k in $(seq 0.125 0.05 0.325); do
                resist_sigmoid_tr=$k
                for l in $(seq 30 15 75); do
                    resist_sigmoid_steepness=$l
                    for m in $(seq 0.125 0.05 0.275); do
                        mask_sigmoid_tr=$m
                        for n in $(seq 6000 500 9000); do
                            weight_pvb=$n
