...
LastEditTime: 2023-11-20 10:49:14
...
class SO(ImplicitProblem):
    def __init__(
        ...
        self.pool = nn.MaxPool2d(kernel_size=mask_scale)
    ...
    def forward(self):
        outer_mask_param = self.pool(self.MO.module.mask_params.unsqueeze(0))
        self.update_mask_value(outer_mask_param.squeeze(0))
