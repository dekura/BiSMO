...
class AbbeLitho:
    ...
    def __init__(
        ...
        resist_sigmoid_steepness: float = 50,
    ...
    def sigmoid_resist(self, aerial):
        return torch.sigmoid(self.resist_sigmoid_steepness * (aerial - self.target_intensity))

    def init_source_value(self):
        self.source_value = self.s.data
        self.source_value = self.source_value.to(self.device)
