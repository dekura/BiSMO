...
LastEditTime: 2023-03-31 15:19:02
...
for i in range(len(tdb.kernelList)):
    ...
    torch_arr_bound(sci_tdb.coefList[i], f"sci_tdb.coefList[{i}]")
    torch_arr_bound(sci_tdb.kernelList[i], f"sci_tdb.kernelList[{i}]")
