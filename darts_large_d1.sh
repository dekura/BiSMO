###
 ...
 # @LastEditTime: 2023-11-12 22:47:54
...
for i in $(seq 20 -1 11); do
    ...
    $python src/bilevel.py problems=pool module.device_id=$device_id mask.layout_path=$layout_path mask.target_path=$layout_path
done
